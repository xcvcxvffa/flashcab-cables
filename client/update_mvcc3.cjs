...
let html = `
  ...
  <div class="mt-8 mb-8">
    <p class="font-semibold text-gray-700 mb-4 text-[20px]">Application of MVCC</p>
    <p class="text-gray-600 mb-6 text-[15px]">Medium voltage-covered conductors are used in a variety of electrical power distribution system scenarios. The following are a few typical uses:</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div class="hidden md:block">
        <img src="/assets/images/Product_Image/mvcc.png" alt="MVCC Applications" class="w-full h-auto object-cover rounded-lg shadow-sm" />
      </div>
    </div>
  </div>
  ...
  <!-- Table 1 -->
  <div>
    <p class="font-semibold text-gray-700 mb-4 mt-12 text-[18px]">Cross Section & Construction Details</p>
    <div class="premium-table-container">
      <table class="premium-spec-table w-full min-w-[600px]">
        <thead>
          <tr>
  ...
  <!-- Table 2 -->
  <div>
    <p class="font-semibold text-gray-700 mb-4 mt-8 text-[18px]">Cross Section & Construction (AL-59 ACS)</p>
    <div class="premium-table-container">
      <table class="premium-spec-table w-full min-w-[600px]">
        <thead>
          <tr>
  ...
  <!-- Table 3 -->
  <div>
    <p class="font-semibold text-gray-700 mb-4 mt-8 text-[18px]">Cable Attributes & Nominal Thickness</p>
    <div class="premium-table-container">
      <table class="premium-spec-table w-full min-w-[800px]">
        ...
        <tbody>
          <tr><td class="primary-cell">1</td><td>Aluminium Alloy Wire</td><td>Sq.mm</td><td colspan="3" class="text-center font-semibold text-[#1e293b]">As Per Requirement</td></tr>
          <tr><td class="primary-cell">2</td><td>Extruded Longitudinal Water Blocking Layer</td><td>mm</td><td colspan="3" class="text-center font-semibold text-[#1e293b]">As Required to make Water Blocked Arrangement</td></tr>
...
const newApplication = `      specificationHtml: '${html.replace(/'/g, "\\'")}'`;

const newProductData = productData.replace(oldApplication, newApplication);

fs.writeFileSync('src/data/productData.js', newProductData);
console.log('Replaced application array safely with specificationHtml for MVCC');
